logback核心模块`slf4j`、`logback-core`、`logback-classic`。
```xml-dtd
<?xml version="1.0" encoding="UTF-8"?>
<!--debug属性可以打印logback内部状态-->
<!--scan属性可以保证当logback的配置文件有变动时自动扫描-->
<!--packingData属性展示包数据-->
<configuration>
    ...
    <!--此处的监听器和configuration的debug属性作用相同-->
    <!--<statusListener class="ch.qos.logback.core.status.OnConsoleStatusListener" />-->

    <!--设置日志目录-->
    <property name="LOG_PATH" value="/opt/springboot-demo/logs" />
    <!--设置系统日志目录-->
    ...
    <!--<appender name="DB" class="ch.qos.logback.classic.db.DBAppender">
        ...
        <connectionSource class="ch.qos.logback.core.db.DriverManagerConnectionSource">
           ...
           <dataSource class="com.mchange.v2.c3p0.ComboPooledDataSource">
              ...
              <url>jdbc:mysql://127.0.0.1:3306/ruida</url>
              <user>root</user>
    ...
    <!--单独设置logger-->
    <!--additivity属性值为false可以去掉appender的叠加性-->
    <logger name="com.ruida.springbootdemo.utils" level="debug" additivity="false">
...
日志优先级别：OFF>FETAL>ERROR>WARN>INFO>DEBUG>TRACE>ALL

一般建议生产环境日志级别为ERROR，开发或者测试环境日志级别为DEBUG或者INFO